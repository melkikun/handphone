...
<head>
   ...
   <title>Halaman Tambah Solusi</title>
   <!-- BOOTSTRAP STYLES-->
    ...
    <div id="page-wrapper" >
            ...
            <div class="row">
               <div class="col-lg-12">
                <div class="alert alert-warning">
                  <strong>Tolong Masukkan Solusi Kerusakan</strong> 
               </div>
            </div>
         </div>
         <?php 
     ...
     if($this->session->flashdata('duplikat')==1){
      ...
      <div class="row">
               <div class="col-lg-12">
                <div class="alert alert-danger">
                  <strong>Kode Solusi Sudah Dipakai !!!!, TOlong Pilih Yang lain !!!</strong> 
               </div>
            </div>
      <?php
     }
     ...
     <div class="row text-center pad-top">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-6">
         ...
         echo form_open('admin/submit/tambahsolusi', $attributes);
         ?>
         <div class="form-group">
            <label class="control-label col-sm-2" for="nama">Kode Solusi Kerusakan</label>
            <div class="col-sm-10">
         ...
         <div class="form-group">
            <label class="control-label col-sm-2" for="nama">Nama Solusi</label>
            <div class="col-sm-10">
               <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Solusi" name="nama">
            </div>
         </div>
        <div class="form-group">        
...
<script type="text/javascript">
   $(document).ready(function($) {
      $('#tambahgejala').validate({
         ...
         messages:{
            nama:"solusi kerusakan tidak boleh kosong",
