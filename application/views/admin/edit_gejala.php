					...
					<div class="row">
						<div class="col-lg-12">
							<div class="alert alert-success">
								<strong>Daftar Nama Gejala Kerusakan</strong> 
							</div>
						</div>
					</div>
					<?php 
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											<a href="<?php echo base_url("admin/editgejala/$value[id]");?>"><button class="glyphicon glyphicon-edit text-danger" style="cursor: pointer;"></button></a>&nbsp;&nbsp;&nbsp;
											<?php
											$attr = array(
												"style"=>"display:inline",
												"onsubmit"=>"return cf();"
											);
											echo form_open("admin/deletegejala/$value[id]", $attr);
											?>
