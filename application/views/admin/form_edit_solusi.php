    ...
    <div id="page-wrapper" >
         ...
         <div id="page-inner">
            ...
            <div class="col-lg-12">
              <div class="alert alert-warning">
                <strong>Form Edit Solusi Kerusakan</strong> 
              </div>
            </div>
          </div>
         <?php 
     ...
     <div class="row text-center pad-top">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-6">
         ...
         echo form_open('admin/submit/editsolusi', $attributes);
         ...
         <div class="form-group">
            <label class="control-label col-sm-2" for="nama">Nama Jenis Kerusakan</label>
            <div class="col-sm-10">
