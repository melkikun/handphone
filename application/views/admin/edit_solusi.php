					...
					<div class="row">
						<div class="col-lg-12">
							<div class="alert alert-success">
								<strong>Daftar Nama Solusi Kerusakan Handphone</strong> 
							</div>
						</div>
					</div>
					<?php 
							...
							<table class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th class="text-center">Solusi Kerusakan</th>
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											<a href="<?php echo base_url("admin/editsolusi/$value[id]");?>"><button class="glyphicon glyphicon-edit text-danger" style="cursor: pointer;"></button></a>&nbsp;&nbsp;&nbsp;
											<?php
											$attr = array(
												"style"=>"display:inline",
												"onsubmit"=>"return cf();"
											);
											echo form_open("admin/deletesolusi/$value[id]", $attr);
											?>
